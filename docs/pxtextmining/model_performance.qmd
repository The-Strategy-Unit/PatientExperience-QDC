...
Please see below the final performance metrics for the models that we have trained and which are available via the API. These are also available in alternative formats to download from our [github repository](https://github.com/CDU-data-science-team/pxtextmining/tree/main/current_best_model).
