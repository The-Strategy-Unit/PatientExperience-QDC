...
This page shows a sample report of some of the additional analyses and graphs that will be available to download for users of the experience dashboard. This additional analysis might be much more useful for key staff working with the patient experience data and it aims to provide a more in-depth analysis of the comments so users can gain additional insights.

Please note that the data used for this report has been modified and the categories have been randomly assigned only for demonstration purposes. The aim of this sample report is to give you a feel of what will be delivered and not for a conclusion to be drawn.
...
source("https://raw.githubusercontent.com/CDU-data-science-team/experiencesdashboard/0.6.0/R/utils_overlap_plot_helpers.R")

df <- readr::read_csv("https://raw.githubusercontent.com/CDU-data-science-team/experiencesdashboard/0.6.0/data-raw/multilabeled_data.csv", show_col_types = FALSE) |>
  select(-`...1`)
...
## 3. Word co-occurrence across categories
...
2.  comments with over 3 labels attached
...
In this sample data, there is a total of ***`r n_complex_comments`*** comments out of a total of ***`r total_comments`*** comments that might need additional attention.

The data of complex comments (if any) are now available to download from the dashboard as of version 0.7.0, so users can further interrogate the comments and the assigned categories.
